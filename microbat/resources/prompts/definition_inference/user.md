...
In your response, strictly return <T> for true and <F> for false. You can first use <thought></thought> tags to express your thought process, but the final answer should be in the format "Answer: <T>" or "Answer: <F>".
