...
public class VarExpansionExampleSearcher extends ExampleSearcher {
	...
	private VarExpansionPromptTemplateFiller promptTemplateFiller;
	...
	public Object[] searchForExample(HashMap<String, String> datapoint) {
		return searchForExample(datapoint, false);
	}

	public Object[] searchForExample(HashMap<String, String> datapoint, boolean isStructured) {
		/* keys */
		...
		if (isStructured) {
			outputArray[0] = promptTemplateFiller.getExampleStructured(closestExample, groundTruth);
		} else {
	...
	public VariableExpansionExample searchForExampleStructured(HashMap<String, String> datapoint,
		...
		Object[] existingExample = searchForExample(datapoint, true);
		VariableExpansionExample closestExample = (VariableExpansionExample) existingExample[0];
		double maxSimScore = (double) existingExample[1];
